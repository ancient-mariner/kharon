...
compile_num_file = "./compile_num.txt"
build_file = "include/build_version_lib.h"
...
try:
    version_str = "%s_%d.%d-local_%s" % (host, build_num, compile_num, today)
    print("Version: " + version_str)
    with open(build_file, "w") as f:
        f.write('#define LIB_BUILD_VERSION "%s"\n' % version_str);
except:
