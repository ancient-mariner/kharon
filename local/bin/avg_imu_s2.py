#!/usr/bin/env python3
""" averages values in IMU output file ('s2' output). file assumed
to contain white-space and comma separated columngs of numbers representing 
gyr (3 floats), acc (3 floats) and mag (3 floats). an optional 10th 
column (eg, temperature) is accepted but it's ignored
